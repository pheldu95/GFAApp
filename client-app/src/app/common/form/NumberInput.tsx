...
//THIS component is our number input, we can use it anywhere in our app that needs a number input

//typing
//because it's a text input, it will be getting a number, and an HTML Input Element
